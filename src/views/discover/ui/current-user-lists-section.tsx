...
import { useCurrentUserStore, useGetUserPlaylists } from "@/entities/user";
...
export function CurrentUserListsSection() {
  ...
  const { data, isLoading, isError } = useGetUserPlaylists({ username: user?.username ?? "", locale })
